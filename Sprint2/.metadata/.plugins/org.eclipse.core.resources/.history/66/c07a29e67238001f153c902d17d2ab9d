        ...
        while (true) {
            ...
            switch (opcao) {
                case 1:
                    ...
                    System.out.print("Digite o tipo do cliente (simple ou plus): ");
                    String tipoCliente = scanner.nextLine();
                    Cliente cliente = new Cliente(nome, cpf, cep, tipoCliente);
                    fila.adicionarCliente(cliente);
                    break;
                case 2:
                    fila.removerCliente();//remove o primeiro cliente da fila
                    break;
                case 3:
