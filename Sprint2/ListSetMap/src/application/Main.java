...
public class Main {
	...
	private static List<Produto> produtosNoEstoque = new ArrayList<>();
	private static Map<Cliente,List<Pedido>> pedidoMap = new HashMap<>();
	...
	public static void main(String[] args) {
		...
		List<Pedido> pedidos = menuPedidos();
	...
	private static List<Pedido> menuPedidos() {
